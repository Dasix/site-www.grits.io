...
Vagrant.configure("2") do |config|
	...
	#    Vagrant VM just to remap ports.
		...
		config.vm.network :forwarded_port, guest: 3270, host: 3270
		config.vm.network :forwarded_port, guest: 3271, host: 3271
		config.vm.network :forwarded_port, guest: 3272, host: 3272
		config.vm.network :forwarded_port, guest: 3273, host: 3273
		config.vm.network :forwarded_port, guest: 3274, host: 3274
